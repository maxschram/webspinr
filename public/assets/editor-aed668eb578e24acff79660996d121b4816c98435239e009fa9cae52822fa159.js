...
(function() { this.JST || (this.JST = {}); this.JST["sites/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="site-index panel panel-default">\n  <div class="panel-heading">\n    <h3 class="panel-title">Sites</h3>\n  </div>\n  <div class="panel-body">\n    <div class="list-group sites">\n    </div>\n    <div class="new-site">\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["sites/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<span class="new-site-button glyphicon glyphicon-plus" aria-hidden="true">New</span>\n');}return __p.join('');};
}).call(this);
